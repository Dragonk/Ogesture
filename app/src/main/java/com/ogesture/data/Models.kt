...
val GESTURE_ZONES = listOf(
    ZoneConfig(ZoneId.BOTTOM, GestureAction.HOME, longAction = GestureAction.RECENTS, lengthPercent = 80, thicknessDp = 14),
    ZoneConfig(ZoneId.LEFT_EDGE, GestureAction.BACK, longAction = null, lengthPercent = 80, thicknessDp = 14),
    ZoneConfig(ZoneId.RIGHT_EDGE, GestureAction.BACK, longAction = null, lengthPercent = 80, thicknessDp = 14),
)
